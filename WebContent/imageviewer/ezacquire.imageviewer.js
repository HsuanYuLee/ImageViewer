...
//imageviewer
    $.fn.imageviewer = function (options) {
        ...
        $imageViewer[$viewerNumber].init = function(options) {
            ...
            $('#'+options.wapperId).append('<div id=View-'+options.viewNo+'></div>');

            $viewers[options.viewNo] = {
                _minScale: null,
                _currentScale: 1,
                rotate: 0,
                _mouseMode: null,
...
//Inner Functions
    let $innerFunction = {
        renderToolBar : function(options, viewNo) {
        ...
        renderViewer : function(options, viewNo) {
            ...
            */
            ...
            $imageDivElemant[viewNo] = document.getElementById(options.wapperId+'-IMAGEDIV-'+viewNo);
            $tempDivElement[viewNo] = document.getElementById(options.wapperId+'-TEMPDIV-'+viewNo);
            $annotationDivElement[viewNo] = document.getElementById(options.wapperId+'-DRAWDIV-'+viewNo);
                ...
                if (tiff) {
                    ...
                    xhr.onload = function () {
                        ...
                        $image[viewNo].image.onload = function () {
                            ...
                            $innerFunction.drawImage(viewNo);
                        };
                    };
                    xhr.send();
                } else {
        ...
        scale: function(displayMode, viewNo) {
            switch (displayMode) {
                ...
                case 'fitHeight':
                    ...
                    break;
                case 'fitWindow':
                    $viewers[viewNo]._currentScale = $viewers[viewNo]._minScale;
                    break;
                case 'fullSize':
        ...
        rotate: function(degree, viewNo) {
            ...
            ctx.rotate($viewers[viewNo].rotate/180*Math.PI);
